  ...
  <div class="termCondition-page full-width row wrap justify-center items-start content-start q-gutter-x-md q-gutter-y-xs">
    ...
    <div class="col-9 self-start">
      ...
      <p>
        ...
        alle presenti Condizioni Generali; (b) l’ UTENTE violi i diritti (anche di proprietà intellettuale o industriale) di terzi; (c) SUBAPP abbia il fondato sospetto che l’ UTENTE abbia commesso frode, truffa, contraffazione ovvero altri reati; (d) l’ UTENTE agisca in modo contrario alle norme di legge di volta in volta applicabile; (e) l’ UTENTE non soddisfi (più) le esigenze ovvero i requisiti qualitativi richiesti da SUBAPP; (f) l’ UTENTE utilizzi, a insindacabile giudizio di SUBAPP, con i collaboratori di SUBAPP, un linguaggio offensivo, diffamatorio, volgare, osceno o razzista;
      </p>
    </div>
    <div class="col-9 self-start">
